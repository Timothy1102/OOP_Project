...
public class EditorActivity extends AppCompatActivity implements
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null &&
                ...
                TextUtils.isEmpty(weightString) && TextUtils.isEmpty(heightString) && mGender == PetEntry.GENDER_UNKNOWN) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int heightColumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_PET_HEIGHT);
    ...
    public void sendEmail( View view){
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "TIÊM");
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Đi Tiêm Đi");
